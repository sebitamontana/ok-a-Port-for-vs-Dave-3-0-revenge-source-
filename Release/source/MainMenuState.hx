...
class MainMenuState extends MusicBeatState
{
	...
	public static var daveEngineVer:String = '3.0';
	...
	override function create()
	{
		...
		char1 = new Character(900, 60, 'dave', true);
		char1.setGraphicSize(Std.int(char1.width * 0.8));
		add(char1);
		char1.visible = false;

		char2 = new Character(800, 300, 'bambi', true);
		char2.setGraphicSize(Std.int(char2.width * 0.8));
		add(char2);
		char2.visible = false;

		char3 = new Character(800, 400, 'tristan', true);
